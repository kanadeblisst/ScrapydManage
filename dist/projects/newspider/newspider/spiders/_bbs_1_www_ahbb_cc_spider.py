...
class RuleSpider(CrawlSpider):
    name = '_bbs_1_www_ahbb_cc' 
    allowed_domains = ["www.ahbb.cc"]
    start_urls = ["http://www.ahbb.cc/bbs/forum.php"]
    time_extracter = ExtractTime()
    article_url = {".*ahbb.cc/bbs/forum-.*": {"follow": True}, ".*ahbb.cc/bbs/thread.*": {"follow": True}}
    rules = (
    ...
    def parse_content(self, response):
        ...
        extract_rule = {"ir_title": {"xpath": ["//span[@id=\"thread_subject\"]//text()"]}, "ir_authors": {"xpath": ["//div[@id=\"postlist\"]/div[1]//div[@class=\"authi\"]/a[@class=\"xw1\"]//text()"]}, "ir_urltime": {"xpath": ["//div[@id=\"postlist\"]/div[1]//div[@class=\"authi\"]/em//text()"]}, "ir_content": {"xpath": ["//div[@id=\"postlist\"]/div[1]//td[@class=\"t_f\"]//text()"]}, "ir_by4": {"xpath": ["//div[@class=\"z\"]/a[4]//text()"]}, "ir_label": {}, "ir_nresrved1": {}, "ir_nresrved2": {}, "ir_nresrved3": {"xpath": ["//div[@id=\"postlist\"]/table[1]//div[@class=\"hm ptn\"]/span[5]//text()"]}, "ir_readnum": {"xpath": ["//div[@id=\"postlist\"]/table[1]//div[@class=\"hm ptn\"]/span[2]//text()"]}}
